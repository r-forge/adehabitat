...
al., in prep.). In this mountainous area, the elevation strongly
...
Additional mathematical details can be found in Darmon et al. (in
prep.). The canonical OMI analysis is implemented in the function
